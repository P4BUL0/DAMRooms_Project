...
public class Ui_Reservas implements com.trolltech.qt.QUiForm<QDialog>
{
    ...
    public QListView listView_habitaciones;
    ...
    public void setupUi(QDialog Reservas)
    {
        ...
        listView_habitaciones = new QListView(groupBox_habitaciones);
        listView_habitaciones.setObjectName("listView_habitaciones");
        listView_habitaciones.setGeometry(new QRect(0, 20, 571, 191));
        listView_habitaciones.setAutoFillBackground(false);
        ...
        groupBox_reservas.setPalette(palette2);
        QFont font6 = new QFont();
        font6.setFamily("Arial");
        font6.setPointSize(10);
        font6.setBold(true);
        font6.setWeight(75);
        groupBox_reservas.setFont(font6);
        groupBox_reservas.setAutoFillBackground(false);
        groupBox_reservas.setFlat(false);
        groupBox_reservas.setCheckable(false);
        listView_reservas = new QListView(groupBox_reservas);
        listView_reservas.setObjectName("listView_reservas");
        listView_reservas.setGeometry(new QRect(0, 20, 571, 231));
        ...
        font7.setBold(true);
        font7.setWeight(75);
        pushButton_eliminar.setFont(font7);
        ...
        font8.setBold(true);
        font8.setWeight(75);
        pushButton_modificar.setFont(font8);
        ...
        font9.setBold(true);
        font9.setWeight(75);
        pushButton_reservar.setFont(font9);
        ...
        font10.setBold(true);
        font10.setWeight(75);
        pushButton_cancelar.setFont(font10);
        ...
        font12.setBold(true);
        font12.setWeight(75);
        groupBox_cliente.setFont(font12);
        ...
        font13.setBold(true);
        font13.setWeight(75);
        label_clienteDNI.setFont(font13);
        ...
        QWidget.setTabOrder(calendarWidget_Fin, listView_habitaciones);
        QWidget.setTabOrder(listView_habitaciones, listView_reservas);
        QWidget.setTabOrder(listView_reservas, pushButton_eliminar);
    ...
    void retranslateUi(QDialog Reservas)
    {
        ...
        listView_habitaciones.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("Reservas", "Lista de habitaciones", null));
        ...
        listView_reservas.setToolTip(com.trolltech.qt.core.QCoreApplication.translate("Reservas", "Lista de habitaciones", null));
